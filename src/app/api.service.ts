...
export class ApiService {
  ...
  createBeneficiary(formValue: DemographicsFormValue): Observable<Beneficiary> {
    ...
    return this.httpClient.post<BeneficiaryResponse>(ApiService.CREATE_BENEFICIARY_URL, request).pipe(
  ...
  public addPlaidToken(beneficiaryUuid: string, plaidPublicToken: string) {
    ...
    return this.httpClient.post<BeneficiaryResponse>(ApiService.ADD_PLAID_TOKEN_URL, request).pipe(
      map(response => response.beneficiary),
  ...
  public createPayment(beneficiaryUuid: string, amount: number): Observable<Payment> {
    ...
    return this.httpClient.post<PaymentResponse>(ApiService.PAYMENTS_URL, request).pipe(
  ...
  public getPayment(uuid: string): Observable<Payment> {
    return this.httpClient.get<PaymentResponse>(`${ApiService.PAYMENTS_URL}/${uuid}`)
